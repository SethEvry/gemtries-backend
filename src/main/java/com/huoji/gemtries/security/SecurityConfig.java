package com.huoji.gemtries.security;


import com.huoji.gemtries.services.JpaUserDetailsService;
import com.huoji.gemtries.util.KeyGeneratorUtil;
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf(AbstractHttpConfigurer::disable)
				...
				.securityMatcher("/api/**")
				.authorizeHttpRequests(auth -> auth.requestMatchers("/api/login", "/api/users/register")
				.permitAll()
						.anyRequest()
						.authenticated())
